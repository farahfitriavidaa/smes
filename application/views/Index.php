...
<title>𝗦𝗠𝗘𝘀𝗣𝗲𝗱𝗶𝗮</title>
<link rel="shortcut icon" href="<?=base_url()?>assets/logo/logo 2.png">
...
<link href="<?=base_url()?>assets/vendor/prettyphoto/css/prettyPhoto.css" rel="stylesheet" type="text/css">
<link href="<?=base_url()?>assets/vendor/owl-carousel/css/owl.carousel.css" rel="stylesheet" type="text/css">
<link href="<?=base_url()?>assets/vendor/owl-carousel/css/owl.theme.css" rel="stylesheet" type="text/css">

<!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/extralayers.css" media="screen" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/vendor/revslider/css/settings.css" media="screen" />

<!-- GOOGLE FONTS FOR SLIDER REVOLUTION -->
<link href='http://fonts.googleapis.com/css?family=Open+Sans:300,400,700,800' rel='stylesheet' type='text/css'>

<!--[if lte IE 9]><link rel="stylesheet" type="text/css" href="css/ie.css" media="screen" /><![endif]-->
<link href="<?=base_url()?>assets/css/custom.css" rel="stylesheet" type="text/css"><!-- CUSTOM STYLESHEET FOR STYLING -->
<!-- Color Style -->
<link href="<?=base_url()?>assets/colors/color1.css" rel="stylesheet" type="text/css">
<!-- SCRIPTS
  ================================================== -->
	...
	<div class="site-header-wrapper">
        <header class="site-header">
            <div class="container sp-cont">
                <div class="site-logo">
                    <h1><a href="index.html"><img src="<?=base_url()?>assets/logo/logo.png" alt="Logo"></a></h1>
                    <span class="site-tagline">One All Service<br>for Small Medium Enterprises Pedia</span>
                </div>
                <div class="header-right">
                    ...
                    <div class="topnav dd-menu">
                        <ul class="top-navigation sf-menu">
                            <li><a href="results-list.html" data-toggle="modal" data-target="#loginModal">Login</a></li>
                            <li><a href="add-listing-pricing.html">Register</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="navbar">
            <div class="container sp-cont">
                <div class="search-function">
                    ...
                    <span><i class="fa fa-phone"></i> Call us <strong>+62 895-3321-64022</strong> <em>or</em> search</span>
                </div>
                ...
                <nav class="main-navigation dd-menu toggle-menu" role="navigation">
                    <ul class="sf-menu">
                        ...
                        <li><a href="<?=base_url()?>assets/javascript:void(0)">Blog</a>
                            <ul class="dropdown">
                ...
                <div class="search-form">
                    <div class="search-form-inner">
                        <form>
                            <h3>Find a Something</h3>
                            <div class="row">
															<div class="col-md-12">
																	<input type="text" class="form-control">
																	<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#searchModal">Search</a>
															</div>
            ...
            <div class="tp-banner">
            	<ul>	<!-- SLIDE  -->
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide 1">
                        <!-- MAIN IMAGE -->
                        <img src="<?=base_url()?>assets/logo/product.jpg"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption light_heavy_70_shadowed lfb ltt tp-resizeme"
                            ...
                            style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;"> SME Catalog Product UMKM
                        </div>
                        ...
                        <div class="tp-caption light_medium_30_shadowed lfb ltt tp-resizeme"
                            ...
                            style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">
														Layanan untuk pengumpulan data-data produk dari UMKM <br> yang berfungsi untuk pemasaran produk dengan digital
														<!-- Details matter, it's worth<br/>waiting to get it right.<br/><span style="font-size:24px;font-weight:400;">― Steve Jobs</span> -->
                        </div>
                    ...
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide 2">
                        <!-- MAIN IMAGE -->
                        <img src="<?=base_url()?>assets/logo/branding.jpg"  alt="fullslide2"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption light_heavy_70_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endspeed="500"
                            data-endeasing="Power4.easeIn"
                            style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;">SME Branding UMKM
                        </div>
                        ...
                        <div class="tp-caption light_medium_30_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endeasing="Power4.easeIn"
                            style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">
														Layanan untuk membantu para UMKM dalam membuat branding <br> produknya dimulai dari design, analisis umkm, bisnis, dan lainnya.

														<!-- You only live once, but if<br/>you do it right, once is enough.<br/><span style="font-size:24px;font-weight:400;">―  Mae West</span> -->
                        </div>
                    ...
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide 3">
                        <!-- MAIN IMAGE -->
                        <img src="<?=base_url()?>assets/logo/event.jpg"  alt="fullslide6"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption light_heavy_70_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endspeed="500"
                            data-endeasing="Power4.easeIn"
                            style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;">SME Exhibition & Event UMKM
                        </div>
                        ...
                        <div class="tp-caption light_medium_30_shadowed lfb ltt tp-resizeme"
                            ...
                            data-endeasing="Power4.easeIn"
                            style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">
														Layanan untuk menjadi event organizer para UMKM atau Komunitas maupun Paguyuban.
														<!-- Imperfection is beauty, madness<br/> is genius and it's better to be<br/> absolutely ridiculous than<br/> absolutely boring.<br/><span style="font-size:24px;font-weight:400;">―  Marilyn Monroe</span> -->
                        </div>
                        ...
                        <div class="tp-caption bignumbers_white lfb ltt tp-resizeme"
                            ...
                            style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;">03
										...
										<li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide 3">
												<!-- MAIN IMAGE -->
												<img src="<?=base_url()?>assets/logo/comingsoon.jpg"  alt="fullslide6"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
												<!-- LAYERS -->
												...
												<div class="tp-caption light_heavy_70_shadowed lfb ltt tp-resizeme"
														...
														data-endspeed="500"
														data-endeasing="Power4.easeIn"
														style="z-index: 2; max-width: auto; max-height: auto; white-space: nowrap;">COMING SOON
												</div>
												...
												<div class="tp-caption light_medium_30_shadowed lfb ltt tp-resizeme"
														...
														data-endeasing="Power4.easeIn"
														style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">
														Terdapat 2 fitur menarik yang lainnya. Penasarankan?!
														<!-- Imperfection is beauty, madness<br/> is genius and it's better to be<br/> absolutely ridiculous than<br/> absolutely boring.<br/><span style="font-size:24px;font-weight:400;">―  Marilyn Monroe</span> -->
												</div>
  	...
  	<div class="main" role="main">
    	<div id="content" class="content full padding-b0">
            <div class="container">
            	...
            	<div class="row">
                	<div class="col-md-6">
                    	<h1 class="uppercase strong">All About<br> SMEsPedia</h1>
                        <p class="lead">
													Smespedia adalah sebuah singkatan dari <span class="accent-color">Small Medium Enterprises Pedia</span>
												</p>
                    </div>
                    <div class="col-md-6">
                    	<p>Smespedia adalah sebuah platform dalam bentuk all in one services untuk
												memfasilitasi UMKM dan Paguyuban ataupun Komunitas.</p>
                                ...
                                <ul class="owl-carousel carousel-fw" id="vehicle-slider" data-columns="4" data-autoplay="" data-pagination="yes" data-arrows="no" data-single-item="no" data-items-desktop="4" data-items-desktop-small="3" data-items-tablet="2" data-items-mobile="1">
                                    <li class="item">
                                        <div class="vehicle-block format-standard">
                                            <a href="vehicle-details.html" class="media-box"><img src="<?=base_url()?>assets/logo/umkm.jpg" alt=""></a>
                                            <div class="vehicle-block-content">
                                                ...
                                                <h5 class="vehicle-title"><a href="vehicle-details.html">UMKM</a></h5>
             	...
             	<div class="row">
                    ...
                    <div class="col-md-8 col-sm-6">
                        <section class="listing-block latest-news">
                            <div class="listing-header">
                            	<a href="blog.html" class="btn btn-sm btn-default pull-right">Lihat Semua</a>
                                <h3>Informasi Event TerUpdate</h3>
                            </div>
                            <div class="listing-container">
                            	<div class="carousel-wrapper">
                                    <div class="row">
                                        ...
                                        <ul class="owl-carousel carousel-fw" id="testimonials-slider" data-columns="2" data-autoplay="5000" data-pagination="no" data-arrows="no" data-single-item="no" data-items-desktop="2" data-items-desktop-small="1" data-items-tablet="1" data-items-mobile="1">
                                            <li class="item">
                                                <div class="testimonial-block">
                                                    ...
                                                    <div class="testimonial-avatar"><img src="<?php echo base_url()?>assets/logo/farah.jpg" alt="" width="60" height="60"></div>
                                                    <div class="testimonial-info">
                                                        <div class="testimonial-info-in">
                                                            <strong>Farah Fitriavida Arifin</strong><span>CEO</span>
																														<p>D3 Sistem Informasi, Telkom University</p>
                                                        </div>
                                                    </div>
																										<div class="testimonial-avatar"><img src="<?php echo base_url()?>assets/logo/lala.jpg" alt="" width="60" height="60"></div>
																										<div class="testimonial-info">
																												<div class="testimonial-info-in">
																														<strong>Lala Huwaida Mahirah</strong><span>CFO</span>
																														<p>S1 Administrasi Bisnis, Telkom University</p>
																												</div>
																										</div>
                                                </div>
                                            </li>
																						<li class="item">
																								<div class="testimonial-block">
																										...
																										<div class="testimonial-avatar"><img src="<?php echo base_url()?>assets/logo/irfan.jpg" alt="" width="60" height="60"></div>
																										<div class="testimonial-info">
																												<div class="testimonial-info-in">
																														<strong>Muh. Irfan HS</strong><span>CTO</span>
																														<p>D3 Sistem Informasi, Telkom University</p>
																												</div>
																										</div>
																										<div class="testimonial-avatar"><img src="<?php echo base_url()?>assets/logo/fina.jpg" alt="" width="60" height="60"></div>
																										<div class="testimonial-info">
																												<div class="testimonial-info-in">
																														<strong>Jauhari Rafika Yusufina</strong><span>CMO</span>
																														<p>S1 Administrasi Bisnis, Telkom University</p>
																												</div>
																										</div>
																								</div>
                    ...
                    <div class="col-md-4 col-sm-6 sidebar">
                        <section class="listing-block latest-reviews">
                            <div class="listing-header">
                            	<a href="blog-masonry.html" class="btn btn-sm btn-default pull-right">Lihat lebih banyak</a>
                                <h3>Review SME Branding UMKM</h3>
                            </div>
                            <div class="listing-container">
                        ...
                        <section class="connect-with-us widget-block">
                            <h4><i class="fa fa-rss"></i> Ikuti kami</h4>
                            <form role="form">
                                <label for="NewsletterInput" class="sr-only">Email</label>
                                <input type="email" class="form-control" id="NewsletterInput" placeholder="Masukan alamat email">
                                <button type="submit" class="btn btn-sm btn-primary">Submit</button>
                                <span class="meta-data">Tidak perlu khawatir, tidak akan spam</span>
                            </form>
                            <hr>
                            <h4><i class="fa fa-circle"></i> Produk TerLaris</h4>
            	...
            	<div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            <h3>Partner Paguyuban/Komunitas </h3>
                            <a href="#" class="btn btn-default btn-lg">Lihat lebih banyak</a>
                        </div>
                        <div class="col-md-9 col-sm-8">
                            <div class="row">
                                <ul class="owl-carousel" id="make-carousel" data-columns="5" data-autoplay="6000" data-pagination="no" data-arrows="no" data-single-item="no" data-items-desktop="5" data-items-desktop-small="4" data-items-tablet="3" data-items-mobile="3">
                                    <li class="item"> <a href="#"><img src="<?=base_url()?>assets/logo/partnership.png" alt="foto"></a></li>
                                    <li class="item"> <a href="#"><img src="<?=base_url()?>assets/logo/partnership.png" alt=""></a></li>
                                    <li class="item"> <a href="#"><img src="<?=base_url()?>assets/logo/partnership.png" alt=""></a></li>
                                    <li class="item"> <a href="#"><img src="<?=base_url()?>assets/logo/partnership.png" alt=""></a></li>
                                    <li class="item"> <a href="#"><img src="<?=base_url()?>assets/logo/partnership.png" alt=""></a></li>
                                    <li class="item"> <a href="#"><img src="<?=base_url()?>assets/logo/partnership.png" alt=""></a></li>
       		...
       		<div class="container">
                <div class="row">
                	<div class="col-md-4 col-sm-6 footer_widget widget widget_newsletter">
                    	<h4 class="widgettitle">Wanna ask something?</h4>
                        <form>
                        	<input type="text" class="form-control" placeholder="Nama Anda">
                        	<input type="email" class="form-control" placeholder="Email Anda">
													<input type="text" class="form-control" name="notlp" value="Nomor Telp">
													<textarea name="deskripsi" class="form-control" rows="3" cols="80" placeholder="Pertanyaan Anda"></textarea>
                        	<input type="submit" class="btn btn-primary btn-lg" value="Submit">
                        </form>
                    </div>
                	<div class="col-md-3 col-sm-6 footer_widget widget widget_custom_menu widget_links">
                    	<h4 class="widgettitle">Know US</h4>
                        <ul>
                        	<li><a href="#">Home</a></li>
                	...
                	<div class="col-md-5 col-sm-6 footer_widget widget text_widget">
                    	<h4 class="widgettitle">Alamat SMEsPedia</h4>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.3171653377785!2d107.6301746143868!3d-6.971858194963292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e9ad9a473177%3A0x75173644e4d27373!2sGedung%20Manterawu!5e0!3m2!1sid!2sid!4v1594059218379!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    </div>
                </div>
            </div>
     	</div>
        	...
        	<div class="container">
                <div class="row">
                	<div class="col-md-6 col-sm-6 copyrights-left">
                    	<p>&copy; 2020 SMEsPedia. All Rights Reserved</p>
                    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
						...
						<div class="modal-body">
							<h4>Mohon maaf fitur sedang dalam perbaikan</h4>
...
<script src="<?=base_url()?>assets/js/jquery-2.0.0.min.js"></script> <!-- Jquery Library Call -->
<script src="<?=base_url()?>assets/vendor/prettyphoto/js/prettyphoto.js"></script> <!-- PrettyPhoto Plugin -->
<script src="<?=base_url()?>assets/js/ui-plugins.js"></script> <!-- UI Plugins -->
<script src="<?=base_url()?>assets/js/helper-plugins.js"></script> <!-- Helper Plugins -->
<script src="<?=base_url()?>assets/vendor/owl-carousel/js/owl.carousel.min.js"></script> <!-- Owl Carousel -->
<script src="<?=base_url()?>assets/vendor/password-checker.js"></script> <!-- Password Checker -->
<script src="<?=base_url()?>assets/js/bootstrap.js"></script> <!-- UI -->
<script src="<?=base_url()?>assets/js/init.js"></script> <!-- All Scripts -->
<script src="<?=base_url()?>assets/vendor/flexslider/js/jquery.flexslider.js"></script> <!-- FlexSlider -->
<script src="http://maps.googleapis.com/maps/api/js?sensor=false"></script>

<!-- SLIDER REVOLUTION 4.x SCRIPTS  -->
<script type="text/javascript" src="<?=base_url()?>assets/vendor/revslider/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/vendor/revslider/js/jquery.themepunch.revolution.min.js"></script>
